! Name of package being compiled: TestProgram4a
! 
...
_mainEntry:
	...
	set	0xe0d6e672,r3		! .  hashVal = -522787214
	call	_CheckVersion_P_TestProgram4a_	! .
	cmp	r1,0			! .
	be	_Label_1		! .
	ret				! .
_Label_1:				! .
...
! 
_sourceFileName:
	.ascii	"TestProgram4a.k\0"
_packageName:
	.ascii	"TestProgram4a\0"
	.align
!
! CheckVersion
!
...
!
_CheckVersion_P_TestProgram4a_:
	.export	_CheckVersion_P_TestProgram4a_
	set	0xe0d6e672,r4		! myHashVal = -522787214
	cmp	r3,r4
	be	_Label_2
	set	_CVMess1,r1
	call	_putString
